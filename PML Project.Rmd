...
With this level of accuracy, I'm prepared to run the original `r nrow(testing)`-observation *testing* set in order to predict the respective movement classe.
